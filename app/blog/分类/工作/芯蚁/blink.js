...
function recv(s){
    ...
    if(s.id&&window.BB.bVue){
        ...
        if(s.i.indexOf(fv)!=-1){
            ...
            if(data){
                if(s.id.indexOf('reply')!=-1&&window.CALLS[data.id]){
...
var CLASSARRAY=['Device','Identifier','Task','Event','Interface']
export default {
    load(el,path){
...
<div style="overflow: hidden;width:100%;height:100%">
            ...
            methods:{
                ...
                send(){
                    ...
                    try {
                        ...
                        if(data1['deviceid']){deviceid=data1['deviceid']}
    ...
    initset(el,sucess){
        ...
        this.defaultdata={
            ip:'121.36.21.219',ip1:'171.221.238.16',port:1883,clientid:clientid,
